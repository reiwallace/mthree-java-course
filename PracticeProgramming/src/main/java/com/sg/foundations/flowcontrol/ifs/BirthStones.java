...
public class BirthStones {
    public static void main(String[] args) {
        ...
        int userInput = UserInputUtils.retrieveIntegerInput();

// Match input to month and stone
        switch(userInput) {
            case 1:
            ...
            case 12:
                ...
                break;
            default:
                System.out.println("I think you must be confused, " + userInput + " doesn't match a month.");
                break;
        }
    }
}
